...
Cut AI writing tells and write with a human voice.

This skill should apply to all human-facing prose, such as:
- docs (README, plans, skills, pretty much any text/md file)
- PR descriptions
- commit messages
- code comments
- chat messages
