...
alias lclclaude='CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC="1" CLAUDE_CODE_ATTRIBUTION_HEADER="0" ANTHROPIC_BASE_URL="http://127.0.0.1:8080" ANTHROPIC_API_KEY="local_token" ANTHROPIC_MODEL="fable" ANTHROPIC_DEFAULT_FABLE_MODEL="gemma-coder" ANTHROPIC_DEFAULT_OPUS_MODEL="gemma-coder" ANTHROPIC_DEFAULT_SONNET_MODEL="gemma-coder" ANTHROPIC_DEFAULT_HAIKU_MODEL="gemma-coder" CLAUDE_CODE_DISABLE_1M_CONTEXT="1" claude --effort high'
